...
// (see backend/src/main.ts's setGlobalPrefix('api')), everything else to
// the frontend. Exists because the hosting plan has a limited number of
// app "slots", so both halves of the product have to share one deployment.
...
// pattern used for the Prisma CLI elsewhere in this project).
...
// WebSocket upgrade support (Next.js dev HMR doesn't matter in production,
// but this costs nothing and covers any future use).
